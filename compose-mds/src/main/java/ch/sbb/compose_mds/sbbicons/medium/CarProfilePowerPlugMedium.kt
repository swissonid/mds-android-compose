...
public val MediumGroup.CarProfilePowerPlugMedium: ImageVector
    get() {
        if (_carProfilePowerPlugMedium != null) {
            return _carProfilePowerPlugMedium!!
        }
        _carProfilePowerPlugMedium = Builder(name = "CarProfilePowerPlugMedium", defaultWidth =
                36.0.dp, defaultHeight = 36.0.dp, viewportWidth = 36.0f, viewportHeight =
                36.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = EvenOdd) {
                moveTo(8.928f, 7.591f)
                curveToRelative(0.19f, -0.217f, 0.466f, -0.342f, 0.753f, -0.342f)
                close()
                moveTo(8.928f, 7.591f)
                lineTo(4.852f, 12.25f)
                horizontalLineToRelative(8.898f)
                lineTo(13.75f, 7.248f)
                lineTo(9.681f, 7.248f)
                ...
                close()
                moveTo(27.0f, 13.248f)
                lineTo(4.252f, 13.248f)
                ...
                close()
                moveTo(28.215f, 20.748f)
                arcToRelative(3.5f, 3.5f, 0.0f, false, true, -3.465f, 3.0f)
                arcToRelative(3.5f, 3.5f, 0.0f, false, true, -3.465f, -3.0f)
                horizontalLineToRelative(-8.07f)
                arcToRelative(3.5f, 3.5f, 0.0f, false, true, -3.465f, 3.0f)
                arcToRelative(3.5f, 3.5f, 0.0f, false, true, -3.465f, -3.0f)
                lineTo(3.25f, 20.748f)
                verticalLineToRelative(-7.436f)
                curveToRelative(0.0f, -0.485f, 0.176f, -0.952f, 0.496f, -1.318f)
...
private var _carProfilePowerPlugMedium: ImageVector? = null
