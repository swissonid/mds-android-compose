...
public val LargeGroup.HeartLarge: ImageVector
    get() {
        if (_heartLarge != null) {
            return _heartLarge!!
        }
        _heartLarge = Builder(name = "HeartLarge", defaultWidth = 48.0.dp, defaultHeight = 48.0.dp,
...
private var _heartLarge: ImageVector? = null
