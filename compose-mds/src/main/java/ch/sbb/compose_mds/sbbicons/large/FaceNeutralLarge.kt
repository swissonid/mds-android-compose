...
public val LargeGroup.FaceNeutralLarge: ImageVector
    get() {
        if (_faceNeutralLarge != null) {
            return _faceNeutralLarge!!
        }
        _faceNeutralLarge = Builder(name = "FaceNeutralLarge", defaultWidth = 48.0.dp, defaultHeight
...
private var _faceNeutralLarge: ImageVector? = null
