...
public val LargeGroup.BatteryLevelLowLarge: ImageVector
    get() {
        if (_batteryLevelLowLarge != null) {
            return _batteryLevelLowLarge!!
        }
        _batteryLevelLowLarge = Builder(name = "BatteryLevelLowLarge", defaultWidth = 48.0.dp,
...
private var _batteryLevelLowLarge: ImageVector? = null
