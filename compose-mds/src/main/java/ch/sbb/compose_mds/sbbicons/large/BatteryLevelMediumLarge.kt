...
public val LargeGroup.BatteryLevelMediumLarge: ImageVector
    get() {
        if (_batteryLevelMediumLarge != null) {
            return _batteryLevelMediumLarge!!
        }
        _batteryLevelMediumLarge = Builder(name = "BatteryLevelMediumLarge", defaultWidth = 48.0.dp,
...
private var _batteryLevelMediumLarge: ImageVector? = null
