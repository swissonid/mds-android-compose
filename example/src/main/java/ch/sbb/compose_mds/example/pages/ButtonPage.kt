...
fun ButtonPage() {
    ...
    Column(Modifier.fillMaxWidth()) {
        ...
        SBBPrimaryButton(
            ...
            Toast.makeText(context, "Primary Button disabled clicked", Toast.LENGTH_SHORT).show()
        }
        SBBSecondaryButton(
            modifier = Modifier
                .fillMaxWidth()
        ...
        SBBSecondaryButton(
            ...
            Toast.makeText(context, "Secondary Button disabled clicked", Toast.LENGTH_SHORT).show()
        }
        Row(
            ...
            SBBTertiaryButton(
                ...
                Toast.makeText(context, "Tertiary Button with icon clicked", Toast.LENGTH_SHORT)
                    .show()
            }
            SBBTertiaryButton(
                icon = SBBIcons.Small.DogSmall,
